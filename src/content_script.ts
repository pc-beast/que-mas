...
try {
     ...
     onReadyElement('footer [data-testid="compose-box"] span:nth-child(2) > div > div:nth-child(2) > div > div', () => {
          const textbox = document.querySelector('footer [data-testid="compose-box"] span:nth-child(2) > div > div:nth-child(2) > div > div')
          textbox!.innerHTML = `<div class="qm_box"> <div class="left_text"> <span>Translate</span> </div> <div class="bubble"> <span class="bubble-outer-dot"> <span class="bubble-inner-dot"></span> </span> </div> </div>`
